package com.codestates.sebmainproject009.search.mapper;
...
public interface SearchMapper {
     ...
     default List<Item> jsonArrayToItems(JSONArray jsonArray, User user, String itemName) {
    ...
    default List<Item> jsonArrayToItems(JSONArray jsonArray, String itemName) {
    ...
    default List<ItemList> jsonArrayToItemList(JSONArray jsonArray, User user) {
    ...
    default List<ItemList> jsonArrayToItemList(JSONArray jsonArray) {
